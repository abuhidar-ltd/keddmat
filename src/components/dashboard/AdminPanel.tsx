...
const AdminPanel = () => {
  ...
  const [kpis, setKpis] = useState<{ customers: number; craftsmen: number; whatsappClicks: number; callClicks: number; emergencyClicks: number; emergencyWhatsappClicks: number; emergencyPhoneClicks: number }>({ customers: 0, craftsmen: 0, whatsappClicks: 0, callClicks: 0, emergencyClicks: 0, emergencyWhatsappClicks: 0, emergencyPhoneClicks: 0 });
