...
const Terms = () => {
  ...
  return (
    <div className="min-h-screen bg-brand-surface" dir={dir}>
      <header className="bg-white border-b border-brand-purple/10 shadow-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center py-1">
            <BrandLogo height={36} />
          </Link>
          <Button variant="outline" asChild className="border-brand-purple text-brand-purple hover:bg-brand-purple/5">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="space-y-8">
          <div>
            ...
            <Card className="border-brand-purple/20 rounded-2xl shadow-sm mb-3">
          ...
          <div>
            ...
            <div className="space-y-3">
              <Card className="border-brand-purple/20 rounded-2xl shadow-sm">
                <CardContent className="flex gap-4 items-start pt-6">
                  <div className="p-2.5 rounded-full bg-brand-purple/10 shrink-0 mt-1"><Users className="w-5 h-5 text-brand-purple" /></div>
                  <div>
              ...
              <Card className="border-brand-purple/20 rounded-2xl shadow-sm">
                <CardContent className="flex gap-4 items-start pt-6">
                  <div className="p-2.5 rounded-full bg-brand-purple/10 shrink-0 mt-1"><FileCheck className="w-5 h-5 text-brand-purple" /></div>
                  <div>
              ...
              <Card className="border-brand-purple/20 rounded-2xl shadow-sm">
                <CardContent className="flex gap-4 items-start pt-6">
                  <div className="p-2.5 rounded-full bg-brand-purple/10 shrink-0 mt-1"><CreditCard className="w-5 h-5 text-brand-purple" /></div>
                  <div>
              ...
              <Card className="border-brand-purple/20 rounded-2xl shadow-sm">
                <CardContent className="flex gap-4 items-start pt-6">
                  <div className="p-2.5 rounded-full bg-brand-purple/10 shrink-0 mt-1"><UserCheck className="w-5 h-5 text-brand-purple" /></div>
                  <div>
              ...
              <Card className="border-brand-purple/20 rounded-2xl shadow-sm">
                <CardContent className="flex gap-4 items-start pt-6">
                  <div className="p-2.5 rounded-full bg-brand-purple/10 shrink-0 mt-1"><Ban className="w-5 h-5 text-brand-purple" /></div>
                  <div>
              ...
              <Card className="border-brand-purple/20 rounded-2xl shadow-sm">
                <CardContent className="flex gap-4 items-start pt-6">
                  <div className="p-2.5 rounded-full bg-brand-purple/10 shrink-0 mt-1"><Shield className="w-5 h-5 text-brand-purple" /></div>
                  <div>
          ...
          <Card className="bg-brand-purple/5 border-2 border-brand-purple/25 rounded-2xl">
          ...
          <div 
            className="flex items-center gap-3 p-4 rounded-xl border-2 border-brand-purple/30 bg-brand-purple/5 cursor-pointer hover:border-brand-purple transition-all"
            onClick={() => navigate('/auth?agreed=true')}
          >
            <Checkbox className="h-6 w-6 border-brand-purple data-[state=checked]:bg-brand-purple" />
